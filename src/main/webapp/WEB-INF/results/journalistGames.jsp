...
<div class="menu">
    <div class="insertGioco">
        <form name="insertGioco" action="insertGameServlet" method="post" enctype="multipart/form-data">
            ...
            <input type="date" id="dataDiRilascio" name="dataDiRilascio" >
            ...
            <c:forEach items="${applicationScope['tipologie']}" var="tipologia">
                <input type="checkbox" id="${tipologia.nome}" name="tipologia" value="${tipologia.nome}">
            ...
            <c:forEach items="${applicationScope['piattaforme']}" var="piattaforma">
                <input type="checkbox" id="${piattaforma.nome}" name="piattaforma" value="${piattaforma.nome}">
